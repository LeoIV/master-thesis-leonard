...
def main(args: List[str]):
    ...
    if args.configuration == 'simple_classifier':
        ...
        if 'gan' not in args.configuration:
            model = VLAE(input_dim=input_dim, log_dir=args.logdir,
                         inf0_kernels_strides_featuremaps=[(5, 2, 64), (5, 1, 64)],
                         inf1_kernels_strides_featuremaps=[(5, 2, 64), (5, 1, 64)],
                         ladder0_kernels_strides_featuremaps=[(5, 2, 64), (5, 1, 64)],
                         ladder1_kernels_strides_featuremaps=[(5, 2, 64), (5, 1, 64)],
                         ladder2_kernels_strides_featuremaps=[(5, 2, 64), (5, 2, 64), (5, 1, 64), (5, 1, 64)],
                         gen2_num_units=[1024, 1024],
                         gen1_num_units=[1024, 1024],
                         gen0_kernels_strides_featuremaps=[(5, 2, 128), (5, 2, 128), (5, 2, 64), (5, 2, 64),
                                                           (5, 1, 64), (5, 1, input_dim[-1])],
                         kernel_visualization_layer=args.kernel_visualization_layer, num_samples=args.num_samples,
                         feature_map_layers=args.feature_map_layers, inner_activation=args.inner_activation,
                         decay_rate=args.lr_decay, feature_map_reduction_factor=args.feature_map_reduction_factor,
                         z_dims=args.z_dims, dropout_rate=args.dropout_rate, use_dropout=args.use_dropout,
            ...
            model = VLAEGAN(input_dim=input_dim, log_dir=args.logdir,
                            inf0_kernels_strides_featuremaps=[(4, 2, 512), (4, 1, 256)],
                            inf1_kernels_strides_featuremaps=[(4, 2, 256), (4, 1, 128)],
                            ladder0_kernels_strides_featuremaps=[(4, 2, 512), (4, 1, 512)],
                            ladder1_kernels_strides_featuremaps=[(4, 2, 256), (4, 1, 256)],
                            ladder2_kernels_strides_featuremaps=[(4, 2, 128), (4, 2, 64), (4, 1, 64), (4, 1, 64)],
                            gen2_num_units=[256, 256],
                            gen1_num_units=[256, 256],
                            gen0_kernels_strides_featuremaps=[(4, 1, 512), (4, 2, 256), (4, 2, 128), (4, 2, 64),
                                                              (4, 2, 64), (4, 1, input_dim[-1])],
                            kernel_visualization_layer=args.kernel_visualization_layer, num_samples=args.num_samples,
                            feature_map_layers=args.feature_map_layers, inner_activation=args.inner_activation,
                            decay_rate=args.lr_decay, feature_map_reduction_factor=args.feature_map_reduction_factor,
                            z_dims=args.z_dims, dropout_rate=args.dropout_rate, use_dropout=args.use_dropout,
