...
def main(args: List[str]):
    ...
    if args.configuration == 'simple_classifier':
        ...
        if 'gan' not in args.configuration:
            model = VLAE(input_dim=input_dim, log_dir=args.logdir,
                         inf0_kernels_strides_featuremaps=[(5, 2, 2, 64)],
                         inf1_kernels_strides_featuremaps=[(3, 2, 2, 64)],
                         ladder0_kernels_strides_featuremaps=[(5, 2, 2, 64)],
                         ladder1_kernels_strides_featuremaps=[(3, 2, 2, 64), (3, 1, 2, 64)],
                         ladder2_kernels_strides_featuremaps=[(3, 2, 2, 64), (3, 1, 1, 64)],
                         gen2_num_units=[1024, 1024],
                         gen1_num_units=[1024, 1024],
