...
\citet[pp. 1069, 1070]{squire2012fundamental} hypothesize that the subjects' \ac{IT} was impaired, leading to an \say{inability to generate a high-level representation of the object.}
...
\paragraph{Ladder Variational Autoencoder}
