...
Each image $\bm{x}\in \mathcal{X}^m$ can be generated from the factors of variation by a data-generating process $g: \mathcal{S}\times \mathcal{S}\times \mathcal{S}\mapsto \mathcal{X}^m$.
