...
The visual system enables humans and other high developed mammals to make sense of visual stimuli.
The following sections describe how the hierarchical structure of the visual system enables perception of gradually increasing complex visual features.

\subsubsection{Cells}

The brain, together with the spinal cord constitutes the \ac{CNS}~\citep[p. 340]{mack2013principles}.
The \ac{CNS} comprises two types of cells, \textit{neurons} and \textit{glial cells} or \textit{glia}~\citep[p. 71]{mack2013principles}.

Even though glia occur two to ten times more often in the nervous system, neurons are the basic units allowing signal exchange in the nervous system~\citep[p. 24]{mack2013principles}.
Glia, in contrast, surround neurons and play a supportive role but are not directly involved in this signal exchange~\citep[p. 26]{mack2013principles}.
...
The (1) cell body (\textit{soma}) performs metabolism and contains the genetic cell information.
...
The \textit{neocortex}, underlayed by the \textit{white matter}, is the region of the brain enabling cognition~\citep[pp. 341, 392]{mack2013principles}.
...
The first cortical region receiving signals from the retina is the \acf{V1}~\citep[p. 559]{mack2013principles}.
