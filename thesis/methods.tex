...
The models are varied based on the input dimensionality.
A more detailed description can be found in Appendix~\textbf{REF}.
...
For \textsc{Mnist}, a size of $28\times 28$ is used, for dsprites $64\times 64$, for CelebA $128\times 128$, and for ImageNet $224\times 224$.
