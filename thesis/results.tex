...
Therefore, the following experiment was conducted (RQ1 a, see Table~\ref{tbl:research_questions}).
...
The following sections explore feature learning in the latent space and answer by how far \acp{VAE} and \acp{VLAE} satisfy the requirements of latent space disentanglement (RQ2, see Table~\ref{tbl:research_questions}) and separability.
...
Incorporating the additional labels provided by Morpho-\textsc{Mnist} analyzing to what extent the lower layers learn which morphological features of \textsc{MNIST} (RQ4, see Table~\ref{tbl:research_questions}).
...
However, the question remains how indistinguishable these generates samples are from actual samples and whether \ac{VAE}-models resemble the data distribution (RQ7 and RQ8, see Table~\ref{tbl:research_questions}).
